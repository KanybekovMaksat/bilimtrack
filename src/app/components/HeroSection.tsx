    ...
    <section className="relative py-20 lg:py-32 overflow-hidden">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="mx-auto max-w-2xl text-lg text-muted-foreground mb-8">
          Bilimtrack — это цифровая экосистема для учебных заведений. Управляйте студентами, 
          расписанием, группами и всем учебным процессом онлайн.
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
          <Button size="lg" className="w-full sm:w-auto bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700">
            Начать бесплатно
        ...
        <div className="relative mx-auto max-w-5xl h-96 lg:h-[500px]">
          ...
          >
            ...
            <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-32 h-32 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-3xl shadow-2xl flex items-center justify-center z-10">
            ...
            <div className="floating-card absolute top-32 right-16 w-40 h-32 bg-card border rounded-2xl shadow-lg p-4 transform-gpu">
              ...
              <div className="space-y-1">
                <div className="flex gap-1">
                  <div className="w-8 h-6 bg-blue-100 dark:bg-blue-900/30 rounded text-[8px] flex items-center justify-center">ПН</div>
                  <div className="w-8 h-6 bg-blue-100 dark:bg-blue-900/30 rounded text-[8px] flex items-center justify-center">ВТ</div>
                  <div className="w-8 h-6 bg-blue-100 dark:bg-blue-900/30 rounded text-[8px] flex items-center justify-center">СР</div>
                </div>
            ...
            <div className="floating-card absolute bottom-20 left-12 w-40 h-28 bg-card border rounded-2xl shadow-lg p-4 transform-gpu">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 bg-blue-500 rounded-lg flex items-center justify-center text-white text-xs">A1</div>
                  <div className="text-[10px]">15 студентов</div>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 bg-indigo-500 rounded-lg flex items-center justify-center text-white text-xs">B2</div>
            ...
            <div className="floating-card absolute top-12 right-48 w-36 h-24 bg-card border rounded-2xl shadow-lg p-4 transform-gpu">
              ...
              <div className="text-[10px] mt-2 text-muted-foreground">85% за неделю</div>
            </div>
