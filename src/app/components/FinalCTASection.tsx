...
const API_BASE = "https://api.bilimtrack.com";
...
function clientValidate(form: FormState): FieldErrors {
  ...
  if (!form.studentCountRange) errors.studentCountRange = "Выберите диапазон";
  return errors;
}
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} noValidate>
                ...
                <div className="mb-3.5">
                  <label htmlFor="f-size" className="block text-xs font-semibold text-slate-500 mb-1.5">
                    Количество учащихся
                  </label>
                  <select
                    id="f-size"
                    value={form.studentCountRange}
                    onChange={(e) => handleChange("studentCountRange", e.target.value)}
                  ...
                  {errors.studentCountRange && (
                    <p className="mt-1 text-[12.5px] text-red-500">{errors.studentCountRange}</p>
                  )}
                </div>
